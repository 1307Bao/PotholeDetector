...
public class RegisterService {
    ...
    private String createUsername() {
        String username;
        do {
            username = "USER" + Math.round(Math.random() * RANDOM);
    ...
    public RegisterResponse registerByGmail(RegisterByGmailRequest request) {
        ...
        try {
            ...
            if (userRepository.existsByEmail(payload.getEmail())) {
                ...
                String password = passwordEncoder.encode(String.valueOf(Math.round(Math.random() * RANDOM)));
    ...
    public RegisterResponse registerByFacebook(RegisterByFacebookRequest request) throws AppRunTimeException {
        ...
        User user = null;
        String username = createUsername();
        String password = String.valueOf(Math.round(Math.random() * RANDOM));
